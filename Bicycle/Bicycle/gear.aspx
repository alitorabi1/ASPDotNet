<%@ Page Title="" Language="C#" MasterPageFile="~/Bicycle.Master" AutoEventWireup="true" CodeBehind="gear.aspx.cs" Inherits="Bicycle.gear" %>
...
WHERE (ParentProductCategoryName = @cat)">
        <SelectParameters>
